class VehicleTest {
    public static void main(String[] args) {
        ...
        Vehicle fourwheels = new Vehicle("Blue",4);
        String color2 = fourwheels.getColor();
        Integer num = fourwheels.getNumberOfWheels();
        System.out.println("The Vehicle color is: " + color2 +" with " + num + " wheels");
    }
}
